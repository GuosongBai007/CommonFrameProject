...
import com.base.rxgalleryfinal.rxjob.job.ImageThmbnailJobCreate;
    ...
    public void onBindViewHolder(GridViewHolder holder, int position) {
        ...
        if (mediaBean.getId() == Integer.MIN_VALUE) {
            ...
            if (imageLoaderType != 3) {
                ...
                OsCompat.setBackgroundDrawableCompat(holder.mIvMediaImage, mImageViewBg);
                holder.mIvMediaImage.getLayoutParams().width = mImageSize;
                holder.mIvMediaImage.getLayoutParams().height = mImageSize;
                holder.mIvMediaImage.requestLayout();
                FrescoManager.displayImageWithAutoAnim((RecyclingImageView) holder.mIvMediaImage,"file://" + path,mConfiguration.isPlayGif());
            }
        }
    }
