...
import com.base.rxgalleryfinal.anim.Animation;
import com.base.rxgalleryfinal.anim.SlideInUnderneathAnimation;
import com.base.rxgalleryfinal.anim.SlideOutUnderneathAnimation;
...
import com.base.rxgalleryfinal.camera.CustomerCameraActivity;
import com.base.rxgalleryfinal.presenter.impl.MediaGridPresenterImpl;
import com.base.rxgalleryfinal.rxbus.RxBus;
import com.base.rxgalleryfinal.rxbus.RxBusDisposable;
import com.base.rxgalleryfinal.rxbus.event.CloseMediaViewPageFragmentEvent;
import com.base.rxgalleryfinal.rxbus.event.ImageRadioResultEvent;
import com.base.rxgalleryfinal.rxbus.event.MediaCheckChangeEvent;
import com.base.rxgalleryfinal.rxbus.event.OpenMediaPageFragmentEvent;
import com.base.rxgalleryfinal.rxbus.event.OpenMediaPreviewFragmentEvent;
import com.base.rxgalleryfinal.rxbus.event.RequestStorageReadAccessPermissionEvent;
import com.base.rxgalleryfinal.ui.activity.MediaActivity;
import com.base.rxgalleryfinal.ui.adapter.BucketAdapter;
...
import com.base.rxgalleryfinal.ui.widget.FooterAdapter;
import com.base.rxgalleryfinal.ui.widget.HorizontalDividerItemDecoration;
import com.base.rxgalleryfinal.ui.widget.MarginDecoration;
import com.base.rxgalleryfinal.ui.widget.RecyclerViewFinal;
import com.base.rxgalleryfinal.utils.CameraUtils;
import com.base.rxgalleryfinal.utils.DeviceUtils;
import com.base.rxgalleryfinal.utils.EmptyViewUtils;
import com.base.rxgalleryfinal.utils.FileUtils;
import com.base.rxgalleryfinal.utils.Logger;
import com.base.rxgalleryfinal.utils.MediaScanner;
import com.base.rxgalleryfinal.utils.MediaUtils;
import com.base.rxgalleryfinal.utils.PermissionCheckUtils;
import com.base.rxgalleryfinal.utils.SimpleDateUtils;
import com.base.rxgalleryfinal.utils.ThemeUtils;
                        ...
                        if (requestStorageReadAccessPermissionEvent.getType() == RequestStorageReadAccessPermissionEvent.TYPE_WRITE) {
                         ...
                         /*   if (requestStorageReadAccessPermissionEvent.isSuccess()) {
                            ...
                            if (Build.VERSION.SDK_INT > 22) {
                                ...
                                int exStorePermission = ActivityCompat.checkSelfPermission(mMediaActivity,
                                        "android.permission.WRITE_EXTERNAL_STORAGE");

                                if (ContextCompat.checkSelfPermission(mMediaActivity,
                                        Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED || exStorePermission != PackageManager.PERMISSION_GRANTED) {
                                    //先判断有没有权限 ，没有就在这里进行权限的申请
                                    ActivityCompat.requestPermissions(mMediaActivity, PERMISSIONS_STORAGE, REQUEST_EXTERNAL_STORAGE);
...
//        Intent captureIntent = image ? new Intent(MediaStore.ACTION_IMAGE_CAPTURE) : new Intent(MediaStore.ACTION_VIDEO_CAPTURE);
        ...
        if (ContextCompat.checkSelfPermission(MediaGridFragment.this.getContext(),
                Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            //先判断有没有权限 ，没有就在这里进行权限的申请
//                ActivityCompat.requestPermissions(AuthNewPersonIDActivity.this,
//                        new String[]{Manifest.permission.CAMERA}, CAMERA_OK);

            ActivityCompat.requestPermissions(MediaGridFragment.this.getActivity(),
                    PERMISSIONS_STORAGE, REQUEST_EXTERNAL_STORAGE);
        } else {

            Intent captureIntent = image ? new Intent(MediaGridFragment.this.getActivity(), CustomerCameraActivity.class) : new Intent(MediaStore.ACTION_VIDEO_CAPTURE);

     /*   Intent captureIntent = null;
        if (image) {
            captureIntent = new Intent(mMediaActivity, CustomerCameraActivity.class);
...
//            mMediaScanner.scanFile(mImagePath, mConfiguration.isImage() ? IMAGE_TYPE : "", this);
            mMediaScanner.scanFile(path, mConfiguration.isImage() ? IMAGE_TYPE : "", this);
            String uri = "dcb://OldAuthPersonID" + "?cropPathPath=" + path;
            Router.startActivity(MediaGridFragment.this.getActivity(), uri);
