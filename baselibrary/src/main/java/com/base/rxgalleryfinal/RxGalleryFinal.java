package com.base.rxgalleryfinal;
...
import com.base.rxgalleryfinal.rxbus.RxBusResultDisposable;
...
import com.base.rxgalleryfinal.utils.ModelUtils;
import com.base.rxgalleryfinal.utils.StorageUtils;
...
//    }
    ...
    public RxGalleryFinal imageLoader() {
        // 项目只使用Fresco加载图片  所以只允许使用Fresco  没有更多选择
        configuration.setImageLoaderType(0);
        return this;
    }
